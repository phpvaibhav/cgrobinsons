...
class Drivers extends Common_Back_Controller {
  ...
  public function driversPdf()
  {
    ...
    // ---------------------------------------------------------
    $content  = '';
    $content .= '<table border="0" cellspacing="1" cellpadding="4"><tr style="background-color:#707070;color:#FFFFFF;"  nobr="true"><th>Driver Name</th><th>Email</th><th>Contact Number</th></tr>';
