...
class Customers extends Common_Back_Controller {
  ...
  public function customersPdf()
  {
    ...
    // ----------------------------------------------------
    $content = ''; 
    $content .= '<table border="0" cellspacing="1" cellpadding="4"><tr style="background-color:#707070;color:#FFFFFF;"  nobr="true"><th>Customer Name</th><th>Email</th><th>Contact Number</th></tr>';
