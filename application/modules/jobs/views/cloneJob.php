						...
						<div class="row">
							<section class="col col-6">
								<label class="input"> <i class="icon-append fa fa-bookmark"></i>
									<input type="text" name="jobName" placeholder="Job Name" value="<?php echo $job['jobName'].'-'.$parentId; ?>" maxlength="30" size="30">
									<input type="hidden" name="jobId" value="0" >
									<input type="hidden" name="parentId" value="<?php echo encoding($job['jobId']); ?>" >
								</label>
							</section>
							<section class="col col-6">
							    <label class="select">
						...
						<div class="row">
							<section class="col col-6">
								<label class="input"> <i class="icon-append fa fa-calendar"></i>
									<input type="text" name="startDate" placeholder="Creation Date" class="" id="CreationDate" data-dateformat='dd-mm-yy'  readonly="">
								</label>
							</section>
							<section class="col col-6">
